           ...
           <div className="stateConditions">
               ...
               <div className="cardBox">
                   <div className="card" data-aos="flip-left"
                       ...
                       <button className='button'>View Conditions</button>
                   </div>
                   <div className="card" data-aos="flip-left"
                        data-aos-easing="ease-out-cubic"
                        data-aos-duration="2000">
               ...
               <div className="meetUs">
                   <div className="innerMeetUsBox" data-aos="fade-up" data-aos-duration="2000">
                       <h1>When should you see a urologist?</h1>
                       <p>Your primary care doctor can treat you for mild urinary problems, such as a UTI. </p>
                       <p>Your primary care doctor may refer you to a urologist if your symptoms</p>
                       <p>don’t improve or if you have a condition that needs </p>
                       <p>treatments they can’t provide.</p>
